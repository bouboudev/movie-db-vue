  ...
  <div class="home">
    <div class="feature-card">
      <router-link to="/movie/tt0409591">
        <img
          src="https://m.media-amazon.com/images/I/51EBZ3Lh+7L.jpg"
          alt="Batman begins"
          class="featured-img"
        />
        <div class="detail">
          ...
          <p>
            ...
            illum! Quia laboriosam debitis at harum, asperiores in, sint,
            voluptatem repudiandae sit autem magnam expedita cupiditate quo
            error. Voluptatibus, cumque.
          </p>
        </div>
      </router-link>
    </div>
